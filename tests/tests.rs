...
// use anyhow::Result;
// use floracad::vertical::VerticalData;

// // pub fn parse_text_file(file_path: &str) -> Result<VerticalData> {
...
// //         };
// //     }
// //     // Ok(VerticalData { input_method: (), input_station: (), input_elevation: (), input_incoming_grade: (), input_outgoing_grade: (), input_length: (), input_station_interval: () })
// // }
...
//     // use floracad::vertical::{calculate::VerticalCurve, VerticalData};
...
//     //     let vertical_data = parse_text_file("./tests/inputs/VA/input_2.md")?;
//     //     let vertical_alignment = vertical_data.to_vertical_curve()?;
...
//     //             let vertical_data = parse_text_file(path_str)?;    
//     //             let vertical_alignment = vertical_data.to_vertical_curve()?;
//     //             println!("Path: {:?}", path);
//     //             println!("{:#?}", vertical_alignment);
//     //         }
